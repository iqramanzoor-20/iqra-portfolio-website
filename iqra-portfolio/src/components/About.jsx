      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-wrap gap-2">
              {['HTML', 'CSS', 'Tailwind', 'JavaScript', 'React', 'Git', 'GitHub'].map((skill) => (
                <span key={skill} className="bg-zinc-900 px-3 py-1 rounded-full text-sm border-zinc-800 hover:border-purple-500 transition">
                  {skill}
                </span>
              ))}
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
            <div className="bg-zinc-900 p-5 rounded-xl border-zinc-800 hover:border-purple-500 transition">
            ...
            <div className="bg-zinc-900 p-5 rounded-xl border border-zinc-800 hover:border-purple-500 transition">
