            ...
            <div className="pt-4">
              ...
              <div className="flex gap-3">
                ...
                <a
                  href="#"
                  target="_blank"
                  className="px-4 py-2 bg-slate-900 rounded-lg text-cyan-400 hover:bg-purple-500/20 border border-zinc-800 hover:border-purple-500 transition"
                >
                  GitHub
                </a>
                ...
                <a
                  href="#"
                  target="_blank"
                  className="px-4 py-2 bg-slate-900 rounded-lg text-cyan-400 hover:bg-purple-500/20 border-zinc-800 hover:border-purple-500 transition"
                >
                  LinkedIn
                </a>
