    ...
    <section className="flex flex-col md:flex-row items-center justify-between px-8 md:px-20 py-20 bg-black min-h-screen">
      ...
      <div className="max-w-lg">
        ...
        <div className="flex gap-4 mt-6">
          <a href="#projects" className="bg-purple-600 hover:bg-purple-700 px-6 py-2 rounded-md font-semibold text-white">
            View Work
          </a>
          <a href="#contact" className="border border-purple-600 hover:bg-purple-600 px-6 py-2 rounded-md font-semibold text-white">
            Contact Me
          </a>
        </div>
      </div>
      ...
      {/* Right Image */}
      <div className="mt-10 md:mt-0 float-animate"> {/* 👈 yahan class change */}
